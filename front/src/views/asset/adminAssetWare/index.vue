            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                ...
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="请输入仓库名称" clearable style="width: 200px" />
                    </Form-item>
                    <!-- 管理员子级盒子 -->
                    <Form-item label="" prop="adminName">
                        <Input type="text" v-model="searchForm.adminName" placeholder="请输入管理员" clearable style="width: 200px" />
                    </Form-item>
                    <!-- 按钮层 -->
                    <Form-item style="margin-left:10px;" class="br">
                        ...
                        <!-- 删除按钮 -->
                        <Button @click="delAll" type="error" icon="md-trash" ghost shape="circle" size="small" >删除</Button>
                        <!-- 导出按钮 -->
